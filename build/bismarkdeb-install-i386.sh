...
#wget -c http://guilherme.noise.gatech.edu:8000/bismark-dropbear_2011.54-1_i386.deb
#wget -c http://guilherme.noise.gatech.edu:8000/bismark-shaperprobe_2009.10_i386.deb
#wget -c http://guilherme.noise.gatech.edu:8000/bismark-netperf_2.4.4-1_i386.deb
