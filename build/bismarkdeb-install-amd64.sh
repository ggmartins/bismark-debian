...
#wget -c http://guilherme.noise.gatech.edu:8000/bismark-shaperprobe_2009.10_amd64.deb
#wget -c http://guilherme.noise.gatech.edu:8000/bismark-netperf_2.4.4-1_amd64.deb
